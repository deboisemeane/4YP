...
class Sors(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Conv1d(1, 16, 7, 2, padding=padding7)
        self.conv2 = nn.Conv1d(128, 32, 7, 2, padding=padding7)
        self.conv3 = nn.Conv1d(128, 32, 7, 2, padding=padding7)
        self.conv4 = nn.Conv1d(128, 32, 7, 2, padding=padding5)
        self.conv5 = nn.Conv1d(128, 32, 7, 2, padding=padding5)
        self.conv6 = nn.Conv1d(128, 64, 7, 2, padding=padding7)
        self.conv7 = nn.Conv1d(128, 64, 7, 2, padding=padding7)
        self.conv8 = nn.Conv1d(256, 64, 5, 2, padding=padding5)
        self.conv9 = nn.Conv1d(256, 64, 5, 2, padding=padding5)
        self.conv10 = nn.Conv1d(256, 128, 5, 2, padding=padding3)
        self.conv11 = nn.Conv1d(256, 128, 3, 2, padding=padding3)
        ...
        self.norm6 = nn.BatchNorm1d(64)
        self.norm7 = nn.BatchNorm1d(64)
        self.norm8 = nn.BatchNorm1d(64)
        self.norm9 = nn.BatchNorm1d(64)
